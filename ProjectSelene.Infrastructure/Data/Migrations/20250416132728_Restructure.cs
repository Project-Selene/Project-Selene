        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SeleneUserId = table.Column<string>(type: "TEXT", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Artifact_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Artifact_AspNetUsers_SeleneUserId",
                        column: x => x.SeleneUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ModInfo_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_ModInfo_AspNetUsers_LastModifiedById",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Mods_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Mods_AspNetUsers_LastModifiedById",
                        column: x => x.LastModifiedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Mods_AspNetUsers_SeleneUserId",
                        column: x => x.SeleneUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Mods_ModInfo_InfoId",
                        column: x => x.InfoId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ModVersions_Artifact_DownloadId",
                        column: x => x.DownloadId,
                        principalTable: "Artifact",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ModVersions_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_ModVersions_AspNetUsers_LastModifiedById",
                        column: x => x.LastModifiedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ModVersions_AspNetUsers_VerifiedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Artifact_CreatedById",
                table: "Artifact",
                column: "CreatedById");

            migrationBuilder.CreateIndex(
                name: "IX_Artifact_Guid",
                table: "Artifact",
                column: "Guid",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Artifact_SeleneUserId",
                table: "Artifact",
                column: "SeleneUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ModInfo_CreatedById",
                table: "ModInfo",
                column: "CreatedById");

            migrationBuilder.CreateIndex(
                name: "IX_ModInfo_LastModifiedById",
                table: "ModInfo",
                column: "LastModifiedById");

            migrationBuilder.CreateIndex(
                name: "IX_Mods_CreatedById",
                table: "Mods",
                column: "CreatedById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Mods_LastModifiedById",
                table: "Mods",
                column: "LastModifiedById");

            migrationBuilder.CreateIndex(
                name: "IX_Mods_LatestVersionId",
                table: "Mods",
                column: "LatestVersionId");

            migrationBuilder.CreateIndex(
                name: "IX_Mods_SeleneUserId",
                table: "Mods",
                column: "SeleneUserId");

            migrationBuilder.CreateIndex(
                name: "IX_ModVersions_CreatedById",
                table: "ModVersions",
                column: "CreatedById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ModVersions_LastModifiedById",
                table: "ModVersions",
                column: "LastModifiedById");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Mods_ModVersions_LatestVersionId",
                table: "Mods",
                column: "LatestVersionId",
