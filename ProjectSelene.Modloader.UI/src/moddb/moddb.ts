...
export class ModDB {
	...
	private readonly mods = new ModsClient(this.baseUrl, { fetch: (...args) => globalThis.fetch(...args) });
	private readonly storage = new StorageClient(this.baseUrl, { fetch: (...args) => globalThis.fetch(...args) });
