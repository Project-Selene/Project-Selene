...
function loadDevState(): object | undefined {
...
const rootReducer: typeof sliceReducer = (state, action) => {
	if (action.type === 'loadState') {
		return action.payload as ReturnType<typeof sliceReducer>
	}
...
export const store = configureStore({
	...
	devTools: (globalThis.window && window.TEST) || false,
});
